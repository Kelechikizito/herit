import { type Heir, bpsToPercent, fullName, shortAddress } from "@/lib/estate";
 ...
 * caller wants trailing it — a role chip, usually. Shared by the dashboard list and the heir
 * table. */
